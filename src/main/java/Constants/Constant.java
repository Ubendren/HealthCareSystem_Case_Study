...
public class Constant {
	...
	public static final String fetchingageweightage = "SELECT a.Weightage FROM agesreferencetable a WHERE a.Age = :agelimit";
	...
	public static final String fetchingpremiumweighatge = "SELECT p.Premium FROM premiumreferencetable p WHERE p.Weightage = :weightagelimit";
